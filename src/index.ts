...
const diamondsObjectNames2 = ["DIA(WHITE)"];
...
async function setupViewer() {
  ...
  async function loadNewModel() {
    if (ringModel == 1) {
      ...
      await manager.addFromPath("./assets/prsten.glb");
      gsap.to(".loader", {
        x: "100%",
        duration: 0.8,
        ease: "power4.inOut",
      ...
      var diamond = viewer.scene.getObjectByName("DIA(WHITE)");
      //   var diamond2 = viewer.scene.getObjectByName("Diamond");
      var circle = viewer.scene.getObjectByName("Circle");
      viewer.scene.getObjectByName("Circle002")?.removeFromParent();
      viewer.scene.getObjectByName("Circle.003")?.removeFromParent();
      //   var empty = viewer.scene.getObjectByName("Empty.001");
      //   var sphere = viewer.scene.getObjectByName("Sphere"); // kruna i dijamant
      viewer.scene.getObjectByName("Plane")?.removeFromParent();
      viewer.scene.getObjectByName("Plane001")?.removeFromParent();
      ...
      silver = viewer.scene.findObjectsByName("Circle")[0] as any as Mesh<
        BufferGeometry,
        MeshStandardMaterial2
      >;
      gold = viewer.scene.findObjectsByName("Circle")[0] as any as Mesh<
        BufferGeometry,
        MeshStandardMaterial2
      >;
